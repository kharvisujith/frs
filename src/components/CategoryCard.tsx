  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-0 left-0 right-0 p-5">
        <h3 className="font-display text-lg font-bold text-white mb-1.5">{category.name}</h3>
        <p className="text-white/90 text-sm line-clamp-2 mb-2">{category.description}</p>
